...
2. **Auto‑discover leads (default path)**  
...
5. **Return one Markdown report**  
   - Campaign summary  
   - Lead scorecard table  
   - DM drafts grouped by tier  

All logic is specified in [`spec.md`](./spec.md).
...
1. Open the skill in Claude Projects / Custom GPT.  
2. Paste your **campaign brief** when prompted.  
3. Answer 3 clarifying questions (goal, tone, hard filters).  
4. Optionally provide a few “must‑include” leads.  
5. Run the skill and review the Markdown report:
...
For all behavior, constraints, and acceptance criteria, see **[`spec.md`](./spec.md)**.
